...
class GetMarketsResponse extends AbstractStructBase
{
     ...
     * @param \Autovista\VinDeutch\StructType\ETGsettingType $market
     */
    public function __construct($statusCode = null, $statusMsg = null, \Autovista\VinDeutch\StructType\ETGsettingType $market = null)
    {
        $this
     ...
     * @param short $statusCode
     * @return \Autovista\VinDeutch\StructType\GetMarketsResponse
     */
     ...
     * @return \Autovista\VinDeutch\StructType\GetMarketsResponse
     */
    public function setMarket(\Autovista\VinDeutch\StructType\ETGsettingType $market = null)
    {
        $this->Market = $market;
        return $this;
    }
