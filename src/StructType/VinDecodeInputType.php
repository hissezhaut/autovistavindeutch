...
class VinDecodeInputType extends AbstractStructBase
{
     ...
     * The ServiceCode
     * Meta informations extracted from the WSDL
     * - documentation: change behavoiur of weservice itself or only logging part.Request's variable "ServiceId" should allow setting ServiceCode SERVICECODE_ERROR = 1; // bad failures, exceptions and so on SERVICECODE_WARNING = 2; // not very bad failures,
     * that can change result SERVICECODE_NOCACHE = 32; // do not use local cache SERVICECODE_NOREQUEST = 64; // do not request remote servers SERVICECODE_DEBUG_INOUT = 128; // show incoming request / outgoing result SERVICECODE_DEBUG_FUNC1 = 256; // show
     * only main functions call/return SERVICECODE_DEBUG_FUNC2 = 512; // show only middle functions call/return SERVICECODE_DEBUG_FUNC3 = 1024; // show only small functions call/return SERVICECODE_DEBUG_NET = 2048; // network/disk/cache IO
     ...
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var \Autovista\VinDeutch\StructType\ValuationBasicType
     */
     ...
     * The EQBehavior
     * Meta informations extracted from the WSDL
     * - documentation: Change the internal equipment behavior,if there is more then one clearly resultthis flag decides which result to use.0 = Behavior as today, no change in equipment logic. 1 = Return the cheapest equipment. 2 = Return the expensive
     * equipment.
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var short
     ...
     * @param \Autovista\VinDeutch\StructType\ValuationBasicType $valuationData
     * @param short $expectedMakeId
     * @param short $eQBehavior
     */
    public function __construct(\Autovista\VinDeutch\StructType\ETGsettingType $settings = null, $vinCode = null, $serviceId = null, $typeETGCode = null, $extendedOutput = null, $inputStream1 = null, $inputStream2 = null, $serviceCode = null, \Autovista\VinDeutch\StructType\ValuationBasicType $valuationData = null, $expectedMakeId = null, $eQBehavior = null)
    {
        $this
     ...
     * Set Settings value
     * @param \Autovista\VinDeutch\StructType\ETGsettingType $settings
     * @return \Autovista\VinDeutch\StructType\VinDecodeInputType
     */
     ...
     * @return \Autovista\VinDeutch\StructType\ValuationBasicType|null
     */
     ...
     * @return \Autovista\VinDeutch\StructType\VinDecodeInputType
     */
    public function setValuationData(\Autovista\VinDeutch\StructType\ValuationBasicType $valuationData = null)
    {
