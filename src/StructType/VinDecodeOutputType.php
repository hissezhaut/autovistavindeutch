...
class VinDecodeOutputType extends AbstractStructBase
{
     ...
     * @var \Autovista\VinDeutch\StructType\VehicleType
     */
    public $Vehicle;
    /**
     * The Equipment
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Autovista\VinDeutch\StructType\EquipmentType
     */
    public $Equipment;
    /**
     * The Esaco
     ...
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var \Autovista\VinDeutch\StructType\ValuationResponseType
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Autovista\VinDeutch\StructType\ManufacturerInfoType
     */
     ...
     * @param \Autovista\VinDeutch\StructType\VehicleType $vehicle
     * @param \Autovista\VinDeutch\StructType\EquipmentType $equipment
     * @param \Autovista\VinDeutch\StructType\EsacoType $esaco
     * @param string $debugOutput
     * @param \Autovista\VinDeutch\StructType\EquipmentType $extEquipment
     * @param \Autovista\VinDeutch\StructType\EsacoType $extEsaco
     * @param \Autovista\VinDeutch\StructType\ValuationResponseType $valuationResponse
     * @param short $detectedMakeId
     * @param \Autovista\VinDeutch\StructType\ManufacturerInfoType $manufOriginData
     * @param \Autovista\VinDeutch\StructType\ManufacturerInfoType
     ...
     */
    public function __construct($statusCode = null, $statusMsg = null, \Autovista\VinDeutch\StructType\ETGsettingType $settings = null, $vinCode = null, \Autovista\VinDeutch\StructType\VehicleType $vehicle = null, \Autovista\VinDeutch\StructType\EquipmentType $equipment = null, \Autovista\VinDeutch\StructType\EsacoType $esaco = null, $debugOutput = null, \Autovista\VinDeutch\StructType\EquipmentType $extEquipment = null, \Autovista\VinDeutch\StructType\EsacoType $extEsaco = null, \Autovista\VinDeutch\StructType\ValuationResponseType $valuationResponse = null, $detectedMakeId = null, \Autovista\VinDeutch\StructType\ManufacturerInfoType $manufOriginData = null, \Autovista\VinDeutch\StructType\ManufacturerInfoType $manufUnknownEquipment = null, $productionDate = null, $deliveryDate = null, $registrationDate = null, $colourDescription = null, $colourCode = null, $upholsteryDescription = null, $upholsteryCode = null, $topDescription = null, $topCode = null, $deliveryCountry = null)
    {
        $this
    ...
    /**
     * Get Vehicle value
     * @return \Autovista\VinDeutch\StructType\VehicleType|null
     */
     ...
     * @return \Autovista\VinDeutch\StructType\VinDecodeOutputType
     */
    public function setVehicle(\Autovista\VinDeutch\StructType\VehicleType $vehicle = null)
    {
    ...
    /**
     * Get Equipment value
     * @return \Autovista\VinDeutch\StructType\EquipmentType|null
     */
     ...
     * @return \Autovista\VinDeutch\StructType\VinDecodeOutputType
     */
    public function setEquipment(\Autovista\VinDeutch\StructType\EquipmentType $equipment = null)
    {
     ...
     * @return \Autovista\VinDeutch\StructType\VinDecodeOutputType
     */
    public function setExtEquipment(\Autovista\VinDeutch\StructType\EquipmentType $extEquipment = null)
    {
     ...
     * @return \Autovista\VinDeutch\StructType\VinDecodeOutputType
     */
    public function setExtEsaco(\Autovista\VinDeutch\StructType\EsacoType $extEsaco = null)
    {
     ...
     * @return \Autovista\VinDeutch\StructType\ValuationResponseType|null
     */
     ...
     * @return \Autovista\VinDeutch\StructType\VinDecodeOutputType
     */
    public function setValuationResponse(\Autovista\VinDeutch\StructType\ValuationResponseType $valuationResponse = null)
    {
     ...
     * @return \Autovista\VinDeutch\StructType\ManufacturerInfoType|null
     */
     ...
     * @return \Autovista\VinDeutch\StructType\VinDecodeOutputType
     */
    public function setManufOriginData(\Autovista\VinDeutch\StructType\ManufacturerInfoType $manufOriginData = null)
    {
     ...
     * @return \Autovista\VinDeutch\StructType\VinDecodeOutputType
     */
    public function setManufUnknownEquipment(\Autovista\VinDeutch\StructType\ManufacturerInfoType $manufUnknownEquipment = null)
    {
    ...
    {
        if (!\Autovista\VinDeutch\EnumType\ISOcountryType::valueIsValid($deliveryCountry)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $deliveryCountry, implode(', ', \Autovista\VinDeutch\EnumType\ISOcountryType::getValidValues())), __LINE__);
        }
